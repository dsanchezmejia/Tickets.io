...
@section('content')
    @include('parameters.partials.header', ['title' => __('Add Parameter')])
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('parameters.store') }}" autocomplete="off">
                            @csrf
                            ...
                            <div class="pl-lg-4">
                              ...
                              <div class="form-group{{ $errors->has('**field**') ? ' has-danger' : '' }}">
                                  ...
                                  <input type="text" name="**field**" id="input-**field**" class="form-control form-control-alternative{{ $errors->has('**field**') ? ' is-invalid' : '' }}" placeholder="{{ __('**Field**') }}" value="" required autofocus>
